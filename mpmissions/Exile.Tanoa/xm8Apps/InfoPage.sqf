...
_line1Text = "Welcome To BanterGaming Tanoa";
_line2Text = "Rules:";
_line3Text = "No SafeZone Camping Or Stealing";
_line4Text = "No Griefing";
_line5Text = "No Glitching, Duping Or Abusing Bugs";
_line6Text = "No Building On Bridges Or Military Bases";
_line7Text = "If You Break These Rules You Will Be Kicked Or Banned";
_line8Text = "If You Need An Admin, Join Our Teamspeak";
_line9Text = "Teamspeak: 85.236.100.188:10717";
_line10Text = "Please Condider Helping The Community Donate Here!";
_line11Text = "www.bantergaming.co.uk";
_line12Text = "Every Little Helps!";
_line13Text = "Have Fun!";
/////////////////////
//CONFIG
////////////////////
